...
function dummy_run_sim(s::SimParams; num_workers=1, num_games=200)
...
function dummy_run_params(params, num_workers, num_games)
  params = @set params.self_play.sim = dummy_run_sim(params.self_play.sim; num_workers, num_games)
...
function dummy_run_evaluation(d::Benchmark.Single)
  d = @set d.sim = dummy_run_sim(d.sim; num_workers=1, num_games=1)
...
function dummy_run_experiment(e::Experiment, num_workers, num_games)
  params = dummy_run_params(e.params, num_workers, num_games)
...
"""
function dummy_run(experiment::Experiment; dir=nothing, nostdout=false, num_workers = 10, num_games = 75)
  experiment = dummy_run_experiment(experiment, num_workers, num_games)
